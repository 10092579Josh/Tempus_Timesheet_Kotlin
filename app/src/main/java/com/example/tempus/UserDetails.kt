    ...
    fun details() {
        ...
        savebutton.setOnClickListener() {
            ...
            if (password?.text.toString() != conpassword?.text.toString()) {
                ...
                myRef.child(userid.toString()).child("displayname")
                    .setValue(username?.text.toString().replace("\\s".toRegex(), ""))
                myRef.child(userid.toString()).child("password")
                    .setValue(password?.text.toString().replace("\\s".toRegex(), ""))
                myRef.child(userid.toString()).child("confirmkey")
                    .setValue(conpassword?.text.toString().replace("\\s".toRegex(), ""))
                ...
                Toast.makeText(this, "${username.text}:New Details Captured", Toast.LENGTH_SHORT)
                    .show()
