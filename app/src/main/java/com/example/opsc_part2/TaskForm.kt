...
// Create a new list of strings that only contains the non-null values from index [0][8]
            val spinnerList = mutableListOf<String>()
            for (row in MainActivity.TaskClass.tasks) {
                val value = row[8]
                if (value != null) {
...
// Populate the Spinner with the list of strings
            val adapter3 = ArrayAdapter(this, android.R.layout.simple_spinner_item, spinnerList)
